...
export default function WorkoutProgramPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="bg-background px-4 sm:px-10 md:px-[178px] py-10">
      <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-card-foreground text-center mb-8">{program.fields.programName}</h1>
      <div className="bg-card border border-border rounded-xl shadow-md p-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            ...
            <RichTextRenderer document={program.fields.programInformation} />
          </div>
